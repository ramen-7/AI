...
class Node:
    ...
    @staticmethod
    def manhattan(child, goal):
        heuristic = 0
        for i in range(1, 9):
            r_child, c_child, r_goal, c_goal = Node.coordinates(i, child, goal)
            heuristic += abs(r_child-r_goal) + abs(c_child-c_goal)
        return heuristic
    ...
    def move_zero(self, open, closed, goal):
        ...
        if zero_c != 2:
            ...
            child_right.heuristic = Node.manhattan(child_right, goal)
        ...
        if zero_c != 0:
            ...
            child_left.heuristic = Node.manhattan(child_left, goal)
        ...
        if zero_r != 0:
            ...
            child_up.heuristic = Node.manhattan(child_up, goal)
        ...
        if zero_r != 2:
            ...
            child_down.heuristic =  Node.manhattan(child_down, goal)
