...
class Node:
    ...
    @staticmethod
    def euclidean(child, goal):
        heuristic = 0
        for i in range(1, 9):
            r_child, c_child, r_goal, c_goal = Node.coordinates(i, child, goal)
            heuristic += ((r_child-r_goal)**2 + (c_child-c_goal)**2)**0.5
        return heuristic
    ...
    def move_zero(self, open, closed, goal):
        ...
        if zero_c != 2:
            ...
            child_right.heuristic = Node.euclidean(child_right, goal)
        ...
        if zero_c != 0:
            ...
            child_left.heuristic = Node.euclidean(child_left, goal)
        ...
        if zero_r != 0:
            ...
            child_up.heuristic = Node.euclidean(child_up, goal)
        ...
        if zero_r != 2:
            ...
            child_down.heuristic =  Node.euclidean(child_down, goal)
